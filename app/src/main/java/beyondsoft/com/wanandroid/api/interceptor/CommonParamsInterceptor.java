package beyondsoft.com.wanandroid.api.interceptor;
...
import beyondsoft.com.wanandroid.mvp.model.bean.Tag;
...
//        saveCookies(response, request.url().toString());
    ...
    private Request rebuildRequest(Request request) throws IOException {
        ...
        Log.e("TAG", "body = " + (body != null ? body.toString() : "-----"));
        Request newRequest;
